...
public class OrganizationResponseDto {
    ...
    public OrganizationResponseDto (Long id, String name, String CIF, String address, String email, Date endSubscription, Boolean isActivate, LocalDateTime createAt) {
        this.id = id;
        this.name = name;
        this.CIF = CIF;

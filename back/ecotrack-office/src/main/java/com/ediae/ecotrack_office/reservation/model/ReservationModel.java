package com.ediae.ecotrack_office.reservation.model;
...
public class ReservationModel {
    ...
    public ReservationModel (LocalDate date, ReservationStatus status, LocalDateTime createdAt, UserEntity user, ResourceEntity resource) {
        this.date = date;
        this.status = status;

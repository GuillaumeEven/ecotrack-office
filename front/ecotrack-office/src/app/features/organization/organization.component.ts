...
import { OrganizationService } from '@services/index.service';
import { OrganizationResponse } from '@models/index.model';
  ...
  ngOnInit(): void {
    ...
    this.organizationService.getOrganization().subscribe({
      ...
      error: () => {
        ...
        this.errorMessage = 'No se pudo cargar el perfil de empresa.';
        this.isLoading = false;
      }
    });
  }
